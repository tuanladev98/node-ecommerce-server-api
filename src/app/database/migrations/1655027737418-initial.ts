...
export class initial1655027737418 implements MigrationInterface {
    name = 'initial1655027737418'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `product` (`created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `id` int NOT NULL AUTO_INCREMENT, `title` varchar(255) NOT NULL, `description` text NULL, `price` int NOT NULL, `gender` enum ('MALE', 'FEMALE') NOT NULL DEFAULT 'MALE', `image01` varchar(255) NOT NULL, `image02` varchar(255) NOT NULL, `is_delete` tinyint NOT NULL DEFAULT '0', `category_id` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `cart` (`id` int NOT NULL AUTO_INCREMENT, `user_id` int NOT NULL, `product_id` int NOT NULL, `size_id` int NOT NULL, `quantity` int NOT NULL, UNIQUE INDEX `IDX_f091e86a234693a49084b4c2c8` (`user_id`), UNIQUE INDEX `IDX_dccd1ec2d6f5644a69adf163bc` (`product_id`), UNIQUE INDEX `IDX_48b9658e0ab43e7df492f64477` (`size_id`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("DROP INDEX `IDX_48b9658e0ab43e7df492f64477` ON `cart`");
        await queryRunner.query("DROP INDEX `IDX_dccd1ec2d6f5644a69adf163bc` ON `cart`");
